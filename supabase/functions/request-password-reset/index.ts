...
const LOGO_URL = "https://zptbkovdogbxkqzvmffj.supabase.co/storage/v1/object/public/2locks3/2lockLogoBrancaFHD.png";
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 16px rgba(0,32,91,0.08);">
          <tr>
            <td style="background-color:#00205B;padding:24px 32px;" align="center">
              <img src="${LOGO_URL}" alt="Ariia 2lock" height="56" style="display:block;height:56px;width:auto;border:0;outline:none;text-decoration:none;background:transparent;filter:brightness(0) invert(1);-webkit-filter:brightness(0) invert(1);" />
            </td>
          </tr>
          <tr>
